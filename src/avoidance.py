    ...
    for i in range(len(contours)):
        ...
        if area > FRAME_SIZE**2 / 15 and area < FRAME_SIZE**2 / 5:
            ...
            if (center_x <= 120):
                ...
                time.sleep(4)
                vehicle.simple_goto(waypoint)
            # the obstacle is on the center_right of the screen
            elif (center_x > 240) and (center_x < 360):
                print("turn left")
                print("stop the drone for 2 secs")
